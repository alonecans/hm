/*
* Bot Ini Saya Bagikan gratis untuk penginstalan bisa minta di link bawah ini
   ...
   nuy.on('chat-update', async (mek) => {
      try {
         ...
         if (messagesLink.includes('desah')) {
            nuy.updatePresence(from, Presence.composing);
            const loli = fs.readFileSync('./mp3/dj desah.mp3');
            nuy.sendMessage(from, loli, MessageType.audio, { quoted: mek, mimetype: 'audio/mp4', ptt: true });
         }
         ...
         if (messagesLink.includes('#menu')) {
            nuy.updatePresence(from, Presence.composing);
            const loli = fs.readFileSync('./mp3/sempai.mp3');
            nuy.sendMessage(from, loli, MessageType.audio, { quoted: mek, mimetype: 'audio/mp4', ptt: true });
         }
         ...
         if (messagesLink.includes('sholawat1')) {
            nuy.updatePresence(from, Presence.composing);
            const loli = fs.readFileSync('./mp3/sholawat1.mp3');
            nuy.sendMessage(from, loli, MessageType.audio, { quoted: mek, mimetype: 'audio/mp4', ptt: true });
         }
         if (messagesLink.includes('sholawat2')) {
            nuy.updatePresence(from, Presence.composing);
            const loli = fs.readFileSync('./mp3/sholawat2.mp3');
            nuy.sendMessage(from, loli, MessageType.audio, { quoted: mek, mimetype: 'audio/mp4', ptt: true });
         }
         if (messagesLink.includes('sholawat3')) {
            nuy.updatePresence(from, Presence.composing);
         ...
         if (messagesLink.includes('katanyatemen')) {
            nuy.updatePresence(from, Presence.composing);
            const loli = fs.readFileSync('./mp3/katanyatemen.mp3');
            nuy.sendMessage(from, loli, MessageType.audio, { quoted: mek, mimetype: 'audio/mp4', ptt: true });
            const d = fs.readFileSync('./sticker/joget.webp');
         ...
         if (messagesLink.includes('menyukaiku')) {
            nuy.updatePresence(from, Presence.composing);
            const loli = fs.readFileSync('./mp3/mencintai.mp3');
            nuy.sendMessage(from, loli, MessageType.audio, { quoted: mek, mimetype: 'audio/mp4', ptt: true });
            const d = fs.readFileSync('./sticker/joget.webp');
            nuy.sendMessage(from, d, sticker, { quoted: mek });
         }
         if (messagesLink.includes('away')) {
            nuy.updatePresence(from, Presence.composing);
            const loli = fs.readFileSync('./mp3/away.mp3');
            nuy.sendMessage(from, loli, MessageType.audio, { quoted: mek, mimetype: 'audio/mp4', ptt: true });
         }
         if (messagesLink.includes('boma')) {
            nuy.updatePresence(from, Presence.composing);
...
۝♡ۣۜۜ፝͜͜͡͡✿➤ ${prefix}harrypotter
۝♡ۣۜۜ፝͜͜͡͡✿➤ ${prefix}carvedwood
۝♡ۣۜۜ፝͜͜͡͡✿➤ ${prefix}wetglass
۝♡ۣۜۜ፝͜͜͡͡✿➤ ${prefix}multicolor3d
۝♡ۣۜۜ፝͜͜͡͡✿➤ ${prefix}watercolor
۝♡ۣۜۜ፝͜͜͡͡✿➤ ${prefix}luxurygold
۝♡ۣۜۜ፝͜͜͡͡✿➤ ${prefix}galaxywallpaper
۝♡ۣۜۜ፝͜͜͡͡✿➤ ${prefix}lighttext
۝♡ۣۜۜ፝͜͜͡͡✿➤ ${prefix}beautifulflower
۝♡ۣۜۜ፝͜͜͡͡✿➤ ${prefix}puppycute
۝♡ۣۜۜ፝͜͜͡͡✿➤ ${prefix}royaltext
۝♡ۣۜۜ፝͜͜͡͡✿➤ ${prefix}heartshaped
۝♡ۣۜۜ፝͜͜͡͡✿➤ ${prefix}birthdaycake
۝♡ۣۜۜ፝͜͜͡͡✿➤ ${prefix}galaxystyle
۝♡ۣۜۜ፝͜͜͡͡✿➤ ${prefix}hologram3d
۝♡ۣۜۜ፝͜͜͡͡✿➤ ${prefix}greenneon
۝♡ۣۜۜ፝͜͜͡͡✿➤ ${prefix}glossychrome
۝♡ۣۜۜ፝͜͜͡͡✿➤ ${prefix}greenbush
۝♡ۣۜۜ፝͜͜͡͡✿➤ ${prefix}metallogo
۝♡ۣۜۜ፝͜͜͡͡✿➤ ${prefix}noeltext
۝♡ۣۜۜ፝͜͜͡͡✿➤ ${prefix}glittergold
۝♡ۣۜۜ፝͜͜͡͡✿➤ ${prefix}textcake
۝♡ۣۜۜ፝͜͜͡͡✿➤ ${prefix}starsnight
۝♡ۣۜۜ፝͜͜͡͡✿➤ ${prefix}wooden3d
۝♡ۣۜۜ፝͜͜͡͡✿➤ ${prefix}textbyname
۝♡ۣۜۜ፝͜͜͡͡✿➤ ${prefix}writegalacy
۝♡ۣۜۜ፝͜͜͡͡✿➤ ${prefix}galaxybat
۝♡ۣۜۜ፝͜͜͡͡✿➤ ${prefix}snow3d
۝♡ۣۜۜ፝͜͜͡͡✿➤ ${prefix}birthdayday
۝♡ۣۜۜ፝͜͜͡͡✿➤ ${prefix}goldplaybutton
۝♡ۣۜۜ፝͜͜͡͡✿➤ ${prefix}silverplaybutton
۝♡ۣۜۜ፝͜͜͡͡✿➤ ${prefix}freefire

♡ۣۜۜ፝͜͜͡͡✿➤「 *Mc-Bot Funn* 」
...
۝♡ۣۜۜ፝͜͜͡͡✿➤ KALO GA ADA DI MENU JANGAN KETIK!`,
                 ...
                 quoted: {
                   key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: 'status@broadcast' } : {}) },
                     ...
                     imageMessage: {
                       ...
                       jpegThumbnail: fs.readFileSync('./src/mc.jpg');
                    },
                  },
                },
            });
            ...
            case 'info':
               ...
               const daca = fs.readFileSync('./src/mc.jpg');
            ...
            case 'carvedwood':  // Fix Bug By MancaBot & Nurul*
               ...
               txt = args.join(" ")
               buffer = await getBuffer(`http://api.lolhuman.xyz/api/photooxy1/${command}?apikey=7f5a6556983b0bf183028c20&text=${txt}`)
               nuy.sendMessage(from, buffer, image, { quoted: mek });
               break;
            case 'wetglass':
            case 'multicolor3d':
